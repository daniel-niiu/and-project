...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2021 at 02:50 AM
...
INSERT INTO `sales` (`sales_date`, `sales_quantity`, `sales_total`, `sales_location`, `staff_username`, `product_name`, `sales_id`) VALUES
('2021-11-22 02:18:28', 20, '200.00', 'Kuching', 'John Doe', 'Quartz 5000 15W50', 101),
('2021-11-22 02:49:25', 1, '200.00', 'Mukah', 'John Do', 'Quartz 8000 Future GF6 5W30', 102);
...
--
-- Dumping data for table `salesadvisor`
--

INSERT INTO `salesadvisor` (`staff_username`, `staff_password`) VALUES
('John Doe', '12345'),
('JohnDoe@safeway.com', '12345');
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
COMMIT;
